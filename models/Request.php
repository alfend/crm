...
class Request extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['id_client', 'id_metering', 'id_delivery', 'price_delivery', 'id_mounting', 'price_mounting', 'type_price', 'id_company', 'type_deposit', 'status_price', 'status_request'], 'integer'],
            [['date_create', 'date_metering_plan', 'date_metering'], 'safe'],
